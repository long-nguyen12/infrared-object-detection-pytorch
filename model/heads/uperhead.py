...
from model.heads.ppm import PPM
...
class UPerHead(nn.Module):
    ...
    def __init__(
        self, in_channels, channel=128, num_classes: int = 1, scales=(1, 2, 3, 6)
    ):
        super().__init__()
        # PPM Module
        ...
        for in_ch in in_channels[:-1]:  # skip the top layer
            self.fpn_in.append(ResBlock(in_ch, channel, 1))
